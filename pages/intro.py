...
with st.container(border=True):
    st.header("内容")
    st.text(
        "本実験では、5〜10秒程度の発話音声のペアーを聞いていただき、その音声に関する質問にご回答ください。\n\n"
        "各音声ペアには、次の2種類の質問が用意されています。\n"
        "(1) イントネーションの自然さ：ピッチの動き、フレーズ末の上昇・下降、強調などを含むイントネーションが、どちらの音声の方が自然に聞こえるかを評価してください。\n"
        "(2) 明瞭性：発話内容がどちらの音声の方が聞き取りやすいかを評価してください。\n\n"
        "各質問にはスライダー式の評価項目があります。\n"
        "音声を A と B とした場合、スライダーは以下の 5 段階で構成されています。もっとも当てはまる位置を選択してください。\n"
        "(1) Aの方が良い\n"
        "(2) Aの方がやや良い\n"
        "(3) どちらとも言えない\n"
        "(4) Bの方がやや良い\n"
        "(5) Bの方が良い\n\n"
        "どちらとも良い、もしくはどちらとも良くない場合は，「(3) どちらとも言えない」を選んでください。"
    )
